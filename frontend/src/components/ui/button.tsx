  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        wellness: "bg-gradient-wellness text-foreground hover:scale-105 shadow-gentle transition-all duration-300",
        hero: "bg-gradient-hero text-primary-foreground hover:scale-105 shadow-button transition-all duration-300 font-semibold",
        soft: "bg-primary-soft text-foreground hover:bg-primary/20 shadow-card transition-all duration-300",
        royal: "bg-royal text-royal-foreground hover:bg-royal/90 shadow-button transition-all duration-300 font-semibold",
      },
      size: {
